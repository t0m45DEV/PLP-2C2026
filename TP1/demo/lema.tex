...
Para eso simplemente debemos separar en casos, analizando cada posible valor de $c$. Ahora bien, si vemos los contructores de $\caja$ tenemos que puede ser tanto $\nada$ como una $\bombilla{b}$, con algun $b$ de tipo $\bool$. Con esto en mente, volvemos a separar en casos.
...
Para reducir esos llamados a $\notfunc$ debemos volver a separar en casos (les juro que es la ultima vez), y ver que pasa con $b$. Como $b$ es de tipo $\bool$ sabemos que puede ser tanto $\true$ como $\false$. Otra vez, probemos uno por uno. Supongamos, primero, que $b = \true$, es decir, $c = \bombilla{\true}$.
...
El caso de $b = \false$ (donde $c = \bombilla{\false}$) es analogo, como se puede ver a continuación:
